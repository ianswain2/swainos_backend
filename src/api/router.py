...
api_router.include_router(debt_service_router)
...
api_router.include_router(itinerary_destinations_router)
api_router.include_router(fx_router)
api_router.include_router(marketing_web_analytics_router)
